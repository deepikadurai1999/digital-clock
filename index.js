...
function settime () {
    ...
    var hour=new Date().getHours();
     ...
     if(x==hour)
    {
         document.getElementById("imagecontainer").style.backgroundImage="url(./images/breakfast.png)";
...
function settime2(){
    ...
    var hour=new Date().getHours();
     ...
     if(x==hour)
    { 
         document.getElementById("imagecontainer").style.backgroundImage="url(./images/lunch.png)";
...
function settime3(){
    ...
    var hour=new Date().getHours();
     ...
     if(x==hour)
    {
        document.getElementById("imagecontainer").style.backgroundImage="url(./images/goodnight.png)";
